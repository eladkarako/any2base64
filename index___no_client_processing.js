...
function file_handler(file){
  ...
  function message_handler(message){
    switch(message.data.reason){
      ...
      case "read_event_error":      textarea.value = "Error!";                                                                                           reader = null;  break;
      case "read_event_load":       textarea.value = "(updating...)";  textarea.value = "data:" + type + ";base64," + message.data.result;               reader = null;  break;
      default:                      textarea.value = "You Should Not See This.. Error?!?!";                                                              reader = null;  break;
    }
  }
